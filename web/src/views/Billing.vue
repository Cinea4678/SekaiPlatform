...
import { Calendar, CreditCard, Download } from 'lucide-vue-next'
import { ref } from 'vue'
      ...
      <Card>
        ...
        <CardContent>
          <div class="space-y-4">
            ...
            <Button variant="outline" size="sm" class="w-full" @click="changePlan">
              Change Plan
            </Button>
          </div>
        </CardContent>
      ...
      <Card>
        ...
        <CardContent>
          <div class="space-y-4">
            ...
            <Button variant="outline" size="sm" class="w-full" @click="updatePaymentMethod">
